...
def visualize_array_difference(arr1, arr2, diff_type='absolute'):
    ...
    np.save(f"{diff_type}_maskd_S23.npy", difference)
...
array1 = np.load("runs/detect/exp/exp2/2007_003020/stage23_C3_features.npy")
array2 = np.load("runs/detect/exp70/2007_003020/stage23_C3_features.npy")
